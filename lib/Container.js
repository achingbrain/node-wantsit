...
Container.prototype.register = function(name, component) {
	check.verifyString(name, "Please pass a string as the component name");
	check.verifyObject(component, "Please pass an object to register");
...
Container.prototype.autowire = function(component) {
	check.verifyObject(component, "Please pass an object to autowire");
...
Container.prototype.createAndRegister = function(name, component) {
	check.verifyString(name, "Please pass a string as the component name");
	check.verifyFunction(component, "Please pass a function to use as the component constructor");
